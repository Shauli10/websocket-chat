...
class ChatRoom extends Actor {
  ...
  def receive = {
    ...
    case Join(username) => {
      ...
      //      val (out: Enumerator[JsValue], channel: Channel[JsValue]) = Concurrent.broadcast[JsValue](onStart = (channel: Concurrent.Channel[JsValue]) => self ! NotifyJoin(username))
      val (out: Enumerator[JsValue], channel: Channel[JsValue]) = Concurrent.broadcast[JsValue]
